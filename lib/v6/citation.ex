defmodule Fhir.v6().Citation do
  ...
  typedstruct do
    ...
    field(:citedArtifact, Fhir.v6().CitationCitedArtifact)
    field(:classification, [Fhir.v6().CitationClassification], default: [])
    ...
    field(:status, :string)
    field(:statusDate, [Fhir.v6().CitationStatusDate], default: [])
    field(:summary, [Fhir.v6().CitationSummary], default: [])

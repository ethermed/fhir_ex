defmodule Fhir.v6().ExampleScenario do
  use TypedStruct
  ...
  typedstruct do
    ...
    field(:actor, [Fhir.v6().ExampleScenarioActor], default: [])
    ...
    field(:instance, [Fhir.v6().ExampleScenarioInstance], default: [])
    field(:jurisdiction, [Fhir.v6().CodeableConcept], default: [])
    field(:language, :string)
    field(:meta, Fhir.v6().Meta)
    field(:modifierExtension, [Fhir.v6().Extension], default: [])
    field(:name, :string)
    field(:process, [Fhir.v6().ExampleScenarioProcess], default: [])

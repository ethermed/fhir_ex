defmodule Fhir.v6().ValueSet do
  ...
  typedstruct do
    ...
    field(:_immutable, Fhir.v6().Element)
    ...
    field(:compose, Fhir.v6().ValueSetCompose)
    ...
    field(:expansion, Fhir.v6().ValueSetExpansion)
    ...
    field(:scope, Fhir.v6().ValueSetScope)
    field(:status, :string)

defmodule Fhir.v6().Evidence do
  use TypedStruct

  typedstruct do
    field(:_approvalDate, Fhir.v6().Element)
    field(:_assertion, Fhir.v6().Element)
    ...
    field(:certainty, [Fhir.v6().EvidenceCertainty], default: [])
    ...
    field(:statistic, [Fhir.v6().EvidenceStatistic], default: [])
    field(:status, :string)
    field(:studyDesign, [Fhir.v6().CodeableConcept], default: [])
    field(:synthesisType, Fhir.v6().CodeableConcept)
    field(:text, Fhir.v6().Narrative)
    field(:title, :string)
    field(:topic, [Fhir.v6().CodeableConcept], default: [])
    field(:url, :string)
    field(:useContext, [Fhir.v6().UsageContext], default: [])
    field(:variableDefinition, [Fhir.v6().EvidenceVariableDefinition], default: [])

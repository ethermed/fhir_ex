defmodule Fhir.Citation do
  ...
  typedstruct do
    ...
    field :_approvalDate, Fhir.Element
        ...
        field :citedArtifact, Fhir.CitationCitedArtifact
        field :classification, [Fhir.CitationClassification], default: []
        ...
        field :status, :string
        field :statusDate, [Fhir.CitationStatusDate], default: []
        field :summary, [Fhir.CitationSummary], default: []

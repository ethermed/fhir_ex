defmodule Fhir.TestPlan do
  ...
  typedstruct do
    ...
    field :_copyright, Fhir.Element
        ...
        field :_exitCriteria, Fhir.Element
        ...
        field :date, :datetime
        field :dependency, [Fhir.TestPlanDependency], default: []
        ...
        field :status, :string
        field :testCase, [Fhir.TestPlanTestCase], default: []

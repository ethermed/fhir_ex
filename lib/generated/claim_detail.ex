defmodule Fhir.ClaimDetail do
  ...
  embedded_schema do
    ...
    embeds_many(:subDetail, Fhir.ClaimSubDetail)
  ...
  @type t :: %__MODULE__{
          ...
          subDetail: [Fhir.ClaimSubDetail.t()],
          tax: Fhir.Money.t(),
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:subDetail, with: &Fhir.ClaimSubDetail.changeset/2)

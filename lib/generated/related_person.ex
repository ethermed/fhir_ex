defmodule Fhir.RelatedPerson do
  ...
  embedded_schema do
    ...
    embeds_many(:communication, Fhir.RelatedPersonCommunication)
  ...
  @type t :: %__MODULE__{
          ...
          communication: [Fhir.RelatedPersonCommunication.t()],
  ...
  def changeset(schema, params) do
    schema
    |> cast(params, [:active, :birthDate, :gender, :id, :implicitRules, :language, :resourceType])
    ...
    |> cast_embed(:communication, with: &Fhir.RelatedPersonCommunication.changeset/2)

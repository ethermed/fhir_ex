defmodule Fhir.Person do
  ...
  embedded_schema do
    ...
    embeds_many(:communication, Fhir.PersonCommunication)
    embeds_many(:contained, Fhir.ResourceList)
    embeds_many(:extension, Fhir.Extension)
    embeds_many(:identifier, Fhir.Identifier)
    embeds_many(:link, Fhir.PersonLink)
  ...
  @type t :: %__MODULE__{
          ...
          communication: [Fhir.PersonCommunication.t()],
          contained: [Fhir.ResourceList.t()],
          extension: [Fhir.Extension.t()],
          identifier: [Fhir.Identifier.t()],
          link: [Fhir.PersonLink.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:communication, with: &Fhir.PersonCommunication.changeset/2)
    |> cast_embed(:contained, with: &Fhir.ResourceList.changeset/2)
    |> cast_embed(:extension, with: &Fhir.Extension.changeset/2)
    |> cast_embed(:identifier, with: &Fhir.Identifier.changeset/2)
    |> cast_embed(:link, with: &Fhir.PersonLink.changeset/2)

defmodule Fhir.NamingSystem do
  ...
  embedded_schema do
    ...
    embeds_many(:uniqueId, Fhir.NamingSystemUniqueId)
  ...
  @type t :: %__MODULE__{
          ...
          uniqueId: [Fhir.NamingSystemUniqueId.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:uniqueId, with: &Fhir.NamingSystemUniqueId.changeset/2)
    ...
    |> validate_format(:responsible, ~r/^^[\s\S]+$$/)

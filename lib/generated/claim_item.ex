defmodule Fhir.ClaimItem do
  ...
  embedded_schema do
    ...
    embeds_many(:detail, Fhir.ClaimDetail)
    embeds_one(:locationReference, Fhir.Reference)
    embeds_many(:bodySite, Fhir.ClaimBodySite)
  ...
  @type t :: %__MODULE__{
          ...
          detail: [Fhir.ClaimDetail.t()],
          locationReference: Fhir.Reference.t(),
          bodySite: [Fhir.ClaimBodySite.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:detail, with: &Fhir.ClaimDetail.changeset/2)
    |> cast_embed(:locationReference, with: &Fhir.Reference.changeset/2)
    |> cast_embed(:bodySite, with: &Fhir.ClaimBodySite.changeset/2)

defmodule Fhir.ParametersParameter do
  @moduledoc """
  ...
  embedded_schema do
    ...
    embeds_many(:part, Fhir.ParametersParameter)
  ...
  @type t :: %__MODULE__{
          ...
          part: [Fhir.ParametersParameter.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:part, with: &Fhir.ParametersParameter.changeset/2)

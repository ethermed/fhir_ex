defmodule Fhir.CompartmentDefinition do
  ...
  embedded_schema do
    ...
    embeds_one(:_search, Fhir.Element)
    ...
    embeds_many(:resource, Fhir.CompartmentDefinitionResource)
  end
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:_search, with: &Fhir.Element.changeset/2)
    ...
    |> cast_embed(:resource, with: &Fhir.CompartmentDefinitionResource.changeset/2)
    ...
    |> validate_inclusion(:search, [true, false])

defmodule Fhir.ExplanationOfBenefitDetail do
  ...
  embedded_schema do
    ...
    embeds_many(:subDetail, Fhir.ExplanationOfBenefitSubDetail)
  ...
  @type t :: %__MODULE__{
          ...
          subDetail: [Fhir.ExplanationOfBenefitSubDetail.t()],
          tax: Fhir.Money.t(),
  ...
  def changeset(schema, params) do
    schema
    |> cast(params, [:factor, :id, :noteNumber, :sequence])
    ...
    |> cast_embed(:subDetail, with: &Fhir.ExplanationOfBenefitSubDetail.changeset/2)

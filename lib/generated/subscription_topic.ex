defmodule Fhir.SubscriptionTopic do
  @moduledoc """
  ...
  embedded_schema do
    ...
    embeds_many(:eventTrigger, Fhir.SubscriptionTopicEventTrigger)
    ...
    embeds_many(:resourceTrigger, Fhir.SubscriptionTopicResourceTrigger)
    ...
    embeds_many(:notificationShape, Fhir.SubscriptionTopicNotificationShape)
    embeds_many(:contact, Fhir.ContactDetail)
    embeds_one(:_publisher, Fhir.Element)
    embeds_one(:text, Fhir.Narrative)
    embeds_one(:_version, Fhir.Element)
    embeds_many(:modifierExtension, Fhir.Extension)
    embeds_many(:canFilterBy, Fhir.SubscriptionTopicCanFilterBy)
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:eventTrigger, with: &Fhir.SubscriptionTopicEventTrigger.changeset/2)
    ...
    |> cast_embed(:resourceTrigger, with: &Fhir.SubscriptionTopicResourceTrigger.changeset/2)
    ...
    |> cast_embed(:notificationShape, with: &Fhir.SubscriptionTopicNotificationShape.changeset/2)
    ...
    |> cast_embed(:canFilterBy, with: &Fhir.SubscriptionTopicCanFilterBy.changeset/2)

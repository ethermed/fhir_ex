defmodule Fhir.SubscriptionTopic do
  ...
  typedstruct do
    ...
    field :_approvalDate, Fhir.Element
        ...
        field :canFilterBy, [Fhir.SubscriptionTopicCanFilterBy], default: []
        ...
        field :eventTrigger, [Fhir.SubscriptionTopicEventTrigger], default: []
        ...
        field :name, :string
        field :notificationShape, [Fhir.SubscriptionTopicNotificationShape], default: []
        field :publisher, :string
        field :purpose, :string
        field :resourceTrigger, [Fhir.SubscriptionTopicResourceTrigger], default: []

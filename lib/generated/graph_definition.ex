defmodule Fhir.GraphDefinition do
  ...
  embedded_schema do
    ...
    embeds_many(:link, Fhir.GraphDefinitionLink)
    ...
    embeds_many(:node, Fhir.GraphDefinitionNode)
  ...
  @type t :: %__MODULE__{
          ...
          _url: Fhir.Element.t(),
          link: [Fhir.GraphDefinitionLink.t()],
          ...
          node: [Fhir.GraphDefinitionNode.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:link, with: &Fhir.GraphDefinitionLink.changeset/2)
    ...
    |> cast_embed(:node, with: &Fhir.GraphDefinitionNode.changeset/2)
    ...
    |> validate_format(:start, ~r/^[A-Za-z0-9\-\.]{1,64}$/)

defmodule Fhir.ExampleScenario do
  @moduledoc """
  ...
  embedded_schema do
    ...
    embeds_many(:instance, Fhir.ExampleScenarioInstance)
    embeds_many(:identifier, Fhir.Identifier)
    embeds_one(:_copyright, Fhir.Element)
    embeds_one(:_versionAlgorithmString, Fhir.Element)
    embeds_many(:actor, Fhir.ExampleScenarioActor)
    embeds_one(:_language, Fhir.Element)
    embeds_many(:jurisdiction, Fhir.CodeableConcept)
    embeds_many(:process, Fhir.ExampleScenarioProcess)
  end
  ...
  @type t :: %__MODULE__{
          ...
          meta: Fhir.Meta.t(),
          instance: [Fhir.ExampleScenarioInstance.t()],
          identifier: [Fhir.Identifier.t()],
          _copyright: Fhir.Element.t(),
          _versionAlgorithmString: Fhir.Element.t(),
          actor: [Fhir.ExampleScenarioActor.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:instance, with: &Fhir.ExampleScenarioInstance.changeset/2)
    ...
    |> cast_embed(:actor, with: &Fhir.ExampleScenarioActor.changeset/2)

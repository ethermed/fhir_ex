defmodule Fhir.EvidenceReport do
  ...
  embedded_schema do
    ...
    embeds_one(:subject, Fhir.EvidenceReportSubject)
    ...
    embeds_many(:relatesTo, Fhir.EvidenceReportRelatesTo)
  ...
  @type t :: %__MODULE__{
          ...
          subject: Fhir.EvidenceReportSubject.t(),
          ...
          relatesTo: [Fhir.EvidenceReportRelatesTo.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:subject, with: &Fhir.EvidenceReportSubject.changeset/2)
    ...
    |> cast_embed(:relatesTo, with: &Fhir.EvidenceReportRelatesTo.changeset/2)

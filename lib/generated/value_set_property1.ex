defmodule Fhir.ValueSetProperty1 do
  @moduledoc """
  ...
  embedded_schema do
    ...
    embeds_many(:subProperty, Fhir.ValueSetSubProperty)
  ...
  @type t :: %__MODULE__{
          ...
          subProperty: [Fhir.ValueSetSubProperty.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:subProperty, with: &Fhir.ValueSetSubProperty.changeset/2)

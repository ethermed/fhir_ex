defmodule Fhir.ClaimResponseDetail1 do
  ...
  embedded_schema do
    ...
    embeds_many(:subDetail, Fhir.ClaimResponseSubDetail1)
  ...
  @type t :: %__MODULE__{
          ...
          subDetail: [Fhir.ClaimResponseSubDetail1.t()],
          tax: Fhir.Money.t(),
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:subDetail, with: &Fhir.ClaimResponseSubDetail1.changeset/2)

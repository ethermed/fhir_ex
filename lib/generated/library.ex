defmodule Fhir.Library do
  ...
  embedded_schema do
    ...
    embeds_many(:parameter, Fhir.ParameterDefinition)
    ...
    embeds_many(:content, Fhir.Attachment)
  ...
  @type t :: %__MODULE__{
          ...
          parameter: [Fhir.ParameterDefinition.t()],
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:parameter, with: &Fhir.ParameterDefinition.changeset/2)
    ...
    |> cast_embed(:content, with: &Fhir.Attachment.changeset/2)

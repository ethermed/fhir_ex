defmodule Fhir.DeviceDefinitionUdiDeviceIdentifier do
  ...
  embedded_schema do
    ...
    embeds_many(:marketDistribution, Fhir.DeviceDefinitionMarketDistribution)
  ...
  @type t :: %__MODULE__{
          ...
          marketDistribution: [Fhir.DeviceDefinitionMarketDistribution.t()],
          modifierExtension: [Fhir.Extension.t()]
        }

  def changeset(schema, params) do
    schema
    |> cast(params, [:deviceIdentifier, :id, :issuer, :jurisdiction])
    ...
    |> cast_embed(:marketDistribution, with: &Fhir.DeviceDefinitionMarketDistribution.changeset/2)

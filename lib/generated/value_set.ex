defmodule Fhir.ValueSet do
  ...
  embedded_schema do
    ...
    embeds_one(:_immutable, Fhir.Element)
  ...
  def changeset(schema, params) do
    ...
    |> cast_embed(:_immutable, with: &Fhir.Element.changeset/2)
    ...
    |> cast_embed(:scope, with: &Fhir.ValueSetScope.changeset/2)
    ...
    |> cast_embed(:compose, with: &Fhir.ValueSetCompose.changeset/2)
    ...
    |> cast_embed(:expansion, with: &Fhir.ValueSetExpansion.changeset/2)
    ...
    |> validate_inclusion(:immutable, [true, false])
